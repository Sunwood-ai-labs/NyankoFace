...
test('scrubs private origins embedded in retained repository text', () => {
  ...
  try {
    ...
    assert.doesNotMatch(sanitized.description || '', /spaces-runner:8000|nyankoface-mcp:8000|mcp-admin:8001|maintenance-agent:8010/);
