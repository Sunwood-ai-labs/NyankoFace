# Image-generated NyankoFace cat logo

NyankoFace uses an AI-generated cat-face mark as its platform identity. The same
...
- Source asset: `frontend/public/brand/nyankoface-cat-logo.png`

### Prompt

> Create a world-class, memorable logo icon for a platform named NyankoFace,
...
![Generated cat logo on the mobile home page](./imagegen-cat-logo-mobile.jpg)

### Mobile menu

![Generated cat logo with the mobile navigation open](./imagegen-cat-logo-mobile-menu.jpg)

### Desktop

![Generated cat logo on the desktop home page](./imagegen-cat-logo-desktop.jpg)
