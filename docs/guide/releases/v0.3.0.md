...
- **One navigation and one identity:** the portal and Forgejo consume a versioned navigation contract with a safe native fallback. The canonical orange paw mark now covers browser, PWA, maskable, monochrome, auth, error, and documentation surfaces.
