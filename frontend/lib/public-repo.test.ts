...
test('scrubs private origins embedded in retained repository text', () => {
  ...
  try {
    ...
    assert.doesNotMatch(sanitized.description || '', /2130706433:8080|127\.1:8080|0xc0a80104:8080|0x7f\.1:8080|0xc0\.0250\.1\.4:8080|127:8080|10:8080|0:8080|0:80/);
